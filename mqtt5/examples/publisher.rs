...
fn main() {
	env_logger::Builder::from_env(env_logger::Env::new().filter_or("MQTT3_LOG", "mqtt5=debug,mqtt5::logging=trace,publisher=info")).init();
	...
	executor.clone().spawn(
		...
		.then(move |result| {
			...
			// 	.publish(mqtt5::proto::Publication {
			...
			// 		payload_format: mqtt5::proto::PayloadFormat::Bytes,
			// 		response_topic: None,
			// 		will_delay_interval: std::time::Duration::from_secs(0),
